#!/usr/bin/env python3
"""
Enhanced setup script for the Taxonomic Database
...
def init_database(args):
    ...
    if args.docker:
        cmd = ['docker-compose', 'exec', 'web', 'python', '-c', 
               "from db_controller import DatabaseController; controller = DatabaseController(); controller.initialize_database(); print('Database initialized.')"]
    else:
        try:
            # Use the DatabaseController directly
...
def main():
    ...
    init_parser.add_argument('--sample', action='store_true', help='Add sample data')
